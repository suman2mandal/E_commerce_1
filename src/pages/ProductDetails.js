...
const ProductDetails = ({children}) => {
  ...
  return (
      <section className={'pt-32 pb-12 lg:py-32 h-screen fex items-center'}>
               <div className={'container mx-auto'}>
                 <div className={'flex flex-col lg:flex-row items-center'}>
                   ...
                   <div className={'flex-1 text-center lg:text-left'}>
                     ...
                     <button onClick={()=>addToCart(product,parseInt(id))} className={'bg-primary text-white py-4 px-8 uppercase font-semibold text-sm'}>
                         Add to cart
                     </button>
                     </div>
                 </div>
